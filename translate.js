...
// Keeps the Gemini API key server-side (set via `wrangler pages secret put GEMINI_API_KEY`
// or in the Cloudflare Pages dashboard under Settings > Environment variables).
...
export async function onRequestPost(context) {
  ...
  if (!apiKey) {
    return jsonError('Server is missing GEMINI_API_KEY. Set it as a Pages secret.', 500);
  }
